        ...
        <div class="product-card" data-id="${producto.id}">
            ...
            <div class="product-info">
                ...
                <div class="product-precio">
                    ${esConvenir ? '<span class="precio-convenir">Contactar al vendedor para precios</span>' : `<span class="precio-actual">${MONEDA}${(tieneOferta ? producto.precio_oferta : producto.precio).toLocaleString('es-CL')}</span>`}
